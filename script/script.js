...
resultButton.addEventListener('click', () => {
	...
	interval = setInterval(startTimer, 10);
	if(newCoun < 1){
		result__block.classList.add('result__block__activ');
		result__block.classList.remove('result__block__activ2');
		resultsControl = true;
...
open.addEventListener('click', () => {
    ...
    if(resultsControl == false){
		result__block.classList.add('result__block__activ');
		result__block.classList.remove('result__block__activ2');
		resultsControl = true;
	}else{
		result__block.classList.add('result__block__activ2');
		result__block.classList.remove('result__block__activ');
		resultsControl = false;
	}
});
